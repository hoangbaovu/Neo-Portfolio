// generated on 2015-09-30 using generator-gulp-webapp 1.0.3
...
gulp.task('html', ['views', 'styles'], () => {
  ...
  return gulp.src(['app/*.html', '.tmp/*.html'])
    ...
    .pipe(assets.restore())
    .pipe($.useref())
    // .pipe($.if('*.html', $.minifyHtml({conditionals: false, loose: false})))
    .pipe(gulp.dest('dist'));
});
...
gulp.task('build', ['lint', 'html', 'images', 'styles', 'extras'], () => {
